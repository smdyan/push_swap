...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/06 17:18:58 by smdyan            #+#    #+#             */
/*   Updated: 2022/03/06 17:19:23 by smdyan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	ft_instruction_exec(t_stacks *stacks, t_steps *steps)
{
...
static void	ft_min_insertion_steps(t_stacks *stacks, t_steps *steps)
{
	int		min_action;
	t_stack	*first_a;
	t_stack	*first_b;
	...
	while (stacks->b)
	{
		min_action = ft_find_place(stacks, stacks->b, steps, min_action);
		stacks->a = first_a;
...
static void	ft_start_sort(t_stacks *stacks)
{
	...
	while (stacks->count_b != 0)
	{
		...
		ft_min_insertion_steps(stacks, step);
		ft_instruction_exec(stacks, step);
	}
